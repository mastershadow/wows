    ...
    create table "public"."data_fetch" (
        "id" bigint generated by default as identity,
        "occurred" bigint,
        "processed" boolean,
        "interval" bigint,
    ...
    alter table if exists "public"."data_fetch" 
       add constraint "FKptn4mkno6x656ss7hwfhu5kf5" 
       foreign key ("interval") 
       references "public"."interval";

    alter table if exists "public"."data_fetch" 
       add constraint "FKjox9yq5nudf31usad5nan4q52" 
       foreign key ("ticker") 
       references "public"."ticker";

    alter table if exists "public"."indicator_data" 
       add constraint "FK8qwu7rdvxjytigjcc92rteh5q" 
       foreign key ("indicator") 
       references "public"."indicator";

    alter table if exists "public"."indicator_data" 
       add constraint "FKh8cgw89ugwjmpj2d7gq5p3vpp" 
       foreign key ("interval") 
       references "public"."interval";

    alter table if exists "public"."indicator_data" 
       add constraint "FK2kjrpdnvl6qrl5fq00vict6ya" 
       foreign key ("ticker") 
       references "public"."ticker";
